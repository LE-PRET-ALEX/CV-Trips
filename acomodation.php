...
<body>
    ...
    <main id="main">
        ...
        <section class="section2">
            ...
            <div class="botao">
                    <!-- BOTAO ESQUERDA -->
                    <button class="btn-nav" id="btn-ant"><i class="fa-solid fa-angle-left"></i></button>
                    <!-- BOTAO DIREITA -->
        ...
        <section id="section3">
            <div class="esq">
                ...
                <div class="filtro">
                    <button class="enviar_filtro" id="enviar_filtro" type="submit">Filter</button>
                    <button class="limpar_filtro" id="limpar_filtro" type="reset">Clear Filtre</button>
                </div>
            </div>
...
<script>
    //capturar elementos
    const carrosel_deslizar = document.getElementById("carrosel_deslizar");
    ...
    function verificar_fim_carrosel(){
        const totaitems = document.querySelectorAll('.item-acomodation').length;
